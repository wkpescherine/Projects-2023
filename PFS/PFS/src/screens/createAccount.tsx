...
const App : FC = () => {
    ...
    const setEducation = () => {
        if(educationLevel === "HS Dropout"){setEducationLevel("GED"); setWealth(500); setCashOnHand(500)}
    ...
    const saveData = async() =>{
        const stringWealth = wealth.toString()
        const stringCashOnHand = cashOnHand.toString()
        try{
            await AsyncStorage.setItem('username', newUserName);
            await AsyncStorage.setItem('password', newPassword);
            await AsyncStorage.setItem('wealth', stringWealth );
            ...
            await AsyncStorage.setItem('cashOnHand', stringCashOnHand );
